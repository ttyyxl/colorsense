    ...
    <ProtectedRoute>
      <main className="min-h-screen bg-gradient-to-br from-white via-indigo-50 to-white">
        ...
        <section className="mx-auto max-w-5xl px-6 py-8">
          <div className="flex flex-col gap-5 rounded-3xl bg-white p-5 shadow-xl shadow-indigo-100 md:p-7">
            <header>
            ...
            <section className="grid gap-4 rounded-2xl border border-slate-200 bg-slate-50 p-5 md:grid-cols-[1fr_1.08fr]">
              <div>
            ...
            <section className="rounded-2xl border border-slate-200 bg-white p-5">
              ...
              <div className="rounded-b-2xl rounded-tr-2xl border border-t-0 border-indigo-100 bg-white p-4">
...
function SceneCard({ label, selected, onClick }: { label: string; selected: boolean; onClick: () => void }) {
  return (
    <button
      type="button"
      onClick={onClick}
      className={`min-h-16 rounded-2xl border px-4 py-3 text-center text-sm font-semibold transition hover:-translate-y-0.5 ${
        selected
...
function MoodCard({
  ...
  return (
    <button
      type="button"
      onClick={onClick}
      className={`min-h-20 rounded-2xl border px-3 py-3 text-center transition hover:-translate-y-0.5 ${
